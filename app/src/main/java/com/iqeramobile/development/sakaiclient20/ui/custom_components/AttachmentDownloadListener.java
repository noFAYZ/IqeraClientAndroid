...
import com.iqeramobile.development.sakaiclient20.ui.fragments.assignments.AssignmentSubmissionDialogFragment;
...
public class AttachmentDownloadListener implements DownloadListener {
    ...
    private String getCookies(Fragment fragment) {
        ...
        String cookieUrl = fragment.getContext().getString(R.string.COOKIE_URL_2);
