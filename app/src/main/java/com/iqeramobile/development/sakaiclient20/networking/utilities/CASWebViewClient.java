package com.iqeramobile.development.sakaiclient20.networking.utilities;
...
public class CASWebViewClient extends WebViewClient {
    ...
    public WebResourceResponse shouldInterceptRequest(WebView view, String url) {
        ...
        if (url.equals("https://learn.iqeraschools.com/portal") && !gotHeaders)
    ...
    private WebResourceResponse handleRequest(WebView view, String url) {
        ...
        final  String cookie = cookieManager.getCookie(cookieUrl);
