package com.iqeramobile.development.sakaiclient20.ui.custom_components;
            ...
            public void onPageFinished(WebView view, String url) {
                ...
                if(view != null)
                    view.loadUrl("javascript:document.querySelector('nav#skipNav').remove();" +
                            "document.querySelector('div.Mrphs-mainHeader').remove();" +
                            "document.querySelector('nav.Mrphs-siteHierarchy').remove();" +
                            "document.querySelector('div.neoPortletTitleWrap').remove();" +
                            "document.querySelector('nav.Mrphs-toolTitleNav').remove();" +
                            "document.querySelector('#toolMenuWrap').remove();" +
                            "document.querySelector('body').style.paddingTop = 0;" +
                            "document.querySelector('div.Mrphs-pageColumns--single .Mrphs-container').style.margin = 0;" +
                            "document.querySelector('main').style.padding= 0;" +
                            "document.querySelector('#iframe1').height = 350;" +
                            "document.querySelector('footer').remove();" +
                            "document.querySelector('main#content').style.marginTop = 0;" +
                            "document.querySelector('.workspace').style.paddingTop = 0;" +
                            "document.querySelector('div.portalBody').style.marginTop = 0;");
            }
        });
    }
