...
import com.iqeramobile.development.sakaiclient20.networking.utilities.CASWebViewClient;
...
public class LoginActivity extends AppCompatActivity implements CASWebViewClient.SakaiLoadedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String baseUrl = getString(R.string.LOGIN_URL);
        ...
        this.loginWebView.getSettings().setPluginState(WebSettings.PluginState.ON);
        ...
        this.loginWebView.getSettings().supportMultipleWindows();
        this.loginWebView.getSettings().setSupportMultipleWindows(true);
        this.loginWebView.getSettings().setAppCacheEnabled(true);
        this.loginWebView.getSettings().setLoadsImagesAutomatically(true);
        this.loginWebView.getSettings().setMediaPlaybackRequiresUserGesture(true);
        if (android.os.Build.VERSION.SDK_INT >= 21) { CookieManager.getInstance().setAcceptThirdPartyCookies(this.loginWebView, true); }
